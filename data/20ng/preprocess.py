...
# Flatlist of words regardless of the original docs
...
# Get doc indices (which document does each word belong to?)
...
# Save json version of vocabulary for embedding model
